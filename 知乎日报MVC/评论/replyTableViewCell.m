...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if ([self.reuseIdentifier isEqualToString:@"ReplyCell"]) {
        ...
        [_foldButton setTitle:@" · 展示更多" forState:UIControlStateNormal];
        [_foldButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateNormal];
        _foldButton.titleLabel.font = [UIFont systemFontOfSize:14];
        _foldButton.userInteractionEnabled = YES;
        [self.contentView addSubview:_foldButton];
        
        _replyLabel = [[UILabel alloc] init];
        _replyLabel.font = [UIFont systemFontOfSize:15.5];
